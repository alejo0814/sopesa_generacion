        ...
        <table id="miTabla" class="table table-bordered display compact">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{formatNumber( ($resul_rep_fecha[0]->gen_repd_gen_bruta ?? 0) + ($resul_rep_fecha[1]->gen_repd_gen_bruta ?? 0)) }}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber(($resul_rep_fecha[0]->gen_repd_cons_propio ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_propio ?? 0)) }}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber(($resul_rep_fecha[0]->gen_repd_gen_neta ?? 0 )+ ($resul_rep_fecha[1]->gen_repd_gen_neta ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber(($resul_rep_fecha[0]->gen_repd_cap_nominal ?? 0) + ($resul_rep_fecha[1]->gen_repd_cap_nominal ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cap_efectiva ?? 0) +($resul_rep_fecha[1]->gen_repd_cap_efectiva ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_carg_promedio ?? 0) + ($resul_rep_fecha[1]->gen_repd_carg_promedio ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_indice_carg_promed_nominal ?? 0) + ($resul_rep_fecha[1]->gen_repd_indice_carg_promed_nominal ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_operacion ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_operacion ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_disponibilidad ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_disponibilidad ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_disp_generador ?? 0) + ($resul_rep_fecha[1]->gen_repd_disp_generador ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cons_combustible_lts ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_combustible_lts ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cons_combustible_gal ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_combustible_gal ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_efi_comb_bruta ?? 0) + ($resul_rep_fecha[1]->gen_repd_efi_comb_bruta ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_efi_comb_neta ?? 0) + ($resul_rep_fecha[1]->gen_repd_efi_comb_neta ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{formatNumber( ($resul_rep_fecha[0]->gen_repd_con_comb_esp_bruto ?? 0) + ($resul_rep_fecha[1]->gen_repd_con_comb_esp_bruto ?? 0))}}</td>
                </tr>
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cons_comb_esp_neto ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_comb_esp_neto ?? 0))}}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cons_aceite_gal ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_aceite_gal ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_cons_aceite_lts ?? 0) + ($resul_rep_fecha[1]->gen_repd_cons_aceite_lts ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_trab_motor_tc ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_trab_motor_tc ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_last_overhaul ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_last_overhaul ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_last_mantenimiento ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_last_mantenimiento ?? 0))}}</td>
                ...
                <tr>
                    ...
                    <td>{{ formatNumber( ($resul_rep_fecha[0]->gen_repd_hrs_trab_ace_lub_motor ?? 0) + ($resul_rep_fecha[1]->gen_repd_hrs_trab_ace_lub_motor ?? 0))}}</td>
